...
def create_figure(df, ticker="^NSEI"):
    ...
    if "RSI" in df.columns:
        ...
        fig.add_hline(
            y=70, line_dash="dash", line_color="red", opacity=0.5, row=2, col=1
        )
        fig.add_hline(
            y=30, line_dash="dash", line_color="green", opacity=0.5, row=2, col=1
        )
    ...
    fig.update_layout(
        title={
            ...
            "font": {"size": 16, "family": "Ubuntu, sans-serif"},
            "x": 0.01,
            "xanchor": "left",
        },
        yaxis_title="Price",
        ...
        plot_bgcolor="#131722",
        font={"family": "Ubuntu, sans-serif", "color": "#D1D4DC"},
        legend={
            "orientation": "h",
            "yanchor": "bottom",
            "y": 1.01,
